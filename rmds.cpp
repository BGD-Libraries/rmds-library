...
Crmds::Crmds(uint32_t temp_machine_ID) : machine_ID(temp_machine_ID)
{
    autoSendFlag = false;
    can_ID = 0;
}
...
void Crmds::set_mode(Crmds::rmds_mode_e temp_mode)
{
    ...
    else if (mode == PWM_CURRENT_MODE) {
        pwm      = 5000;
        current  = 0;
        velocity = 0;
        position = 0;
    }
    else if (mode == PWM_VELOCITY_MODE) {
        pwm      = 5000;
        current  = 0;
        velocity = 0;
        position = 0;
    }
    else if (mode == PWM_POSITION_MODE) {
        pwm      = 5000;
        current  = 0;
        velocity = 0;
        position = 0;
    }
    else if (mode == PWM_VELOCITY_POSITION_MODE) {
        pwm      = 5000;
        current  = 0;
        velocity = 1000;
        position = 0;
    }
    else if (mode == CURRENT_VELOCITY_MODE) {
        pwm      = 0;
        current  = 3000;
        velocity = 0;
        position = 0;
    }
    else if (mode == CURRENT_POSITION_MODE) {
        pwm      = 0;
        current  = 3000;
        velocity = 0;
        position = 0;
    }
    else if (mode == CURRENT_VELOCITY_POSITION_MODE) {
        pwm      = 0;
        current  = 3000;
        velocity = 1000;
        position = 0;
